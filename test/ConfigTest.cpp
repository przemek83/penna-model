...
//            left.fromYear_ == right.fromYear_ && left.fromAge_ ==
//            right.fromAge_;
// }

// bool operator==(const Config::Population& left, const Config::Population&
// right)
// {
//     return left.max_ == right.max_ && left.initial_ == right.initial_;
// }

// bool operator==(const Config::Mutations& left, const Config::Mutations&
// right)
// {
...
// bool operator==(const Config::Offspring& left, const Config::Offspring&
// right)
// {
...
//         const Config::Params
//         configParams{Config::loadConfig(emptyCofigString)};
//         REQUIRE(defaultParams == configParams);
//     }

//     SECTION("valid config")
//     {
//         const Config::Params expectedParams{2000, 100000, 1000, 2,  6,    6,
//         4,
//                                             50,   2,      4,    20, 2000, 5};
